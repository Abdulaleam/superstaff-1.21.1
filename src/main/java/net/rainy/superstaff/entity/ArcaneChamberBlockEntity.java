...
public class ArcaneChamberBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public ArcaneChamberBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ARCANE_CHAMBER_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> ArcaneChamberBlockEntity.this.progress;
                    case 1 -> ArcaneChamberBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: ArcaneChamberBlockEntity.this.progress = value;
                    case 1: ArcaneChamberBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.translatable("block.superstaff.arcane_chamber");
    }

    @Nullable
    @Override
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new ArcaneChamberScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
